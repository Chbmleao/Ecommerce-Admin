...
export default function Navbar({ show }) {
  ...
  const activeLink = inactiveLink + " bg-secondary-300 text-white rounded-md";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-secondary-200 p-4 fixed w-full h-full bg-secondary-100 md:static md:w-auto transition-all"
      }
    >
